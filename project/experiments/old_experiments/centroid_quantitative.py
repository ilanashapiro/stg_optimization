...
# dir_prefix = "/home/jonsuss/Ilana_Shapiro/constraints/classical_piano_midi_db/"
...
import build_graph
import simanneal_centroid_helpers, simanneal_centroid
...
def generate_centroid(composer_dir, composer):
	...
	# this takes WAY too long to do right now, it's n^2 annealings 
	# initial_centroid_and_alignments = simanneal_centroid_run.initial_centroid_and_alignments(listA_G, idx_node_mapping)
	...
	if os.path.exists(alignments_dir):
		...
		alignments = simanneal_centroid.get_alignments_to_centroid_parallel(initial_centroid, listA_G, centroid_node_mapping, 1.5, 0.01, 500)
...
if __name__ == "__main__":
	# analyze_composer_subdir(os.path.join(DIRECTORY, "schumann"))
	composers = ["bach", "albeniz", "schumann", "haydn"]

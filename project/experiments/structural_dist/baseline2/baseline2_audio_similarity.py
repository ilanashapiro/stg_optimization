...
sys.path.append(f"{DIRECTORY}/experiments/structural_dist/audio-similarity")
...
def run(clusters_filepath):
	...
	cache_filepath = f'{DIRECTORY}/experiments/structural_dist/baseline2/audio_similarity_cache.pkl'
...
if __name__ == "__main__":
	clusters_filepath = f"{DIRECTORY}/experiments/structural_dist/struct_dist_data/clusters_totalnobrahmsnohaydn_mindisttol2.pkl"

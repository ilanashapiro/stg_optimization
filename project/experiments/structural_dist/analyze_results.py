...
sys.path.append(f"{DIRECTORY}/experiments/structural_dist/baseline1")
sys.path.append(f"{DIRECTORY}/experiments/structural_dist/baseline2")
...
if __name__ == "__main__":
	scaler = MinMaxScaler()
	clusters_path = f"{DIRECTORY}/experiments/structural_dist/struct_dist_data/clusters_totalnobrahmsnohaydn_mindisttol2.pkl" 
...
# for cluster: f"{DIRECTORY}/experiments/structural_dist/struct_dist_data/clusters_totalnobrahmsnohaydn_mindisttol2.pkl" 

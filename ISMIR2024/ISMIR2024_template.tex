...
In this paper, we build STGs comprising hierarchical segmentation and disjoint motif pattern repetitions, with plans to add layers for functional harmony and melody in the future. Thus, in this section we discuss the standard MIREX formats for the segmentation and pattern detection problems, and detail how we parse these formats into appropriate representations for the STG. 
\subsection{Parsing} \label{subsec:parsing}
\begin{figure}[h]
  \centering
  \includegraphics[width=\linewidth]{form_parse}
  \caption{Parsing of Formal Segmentation}
  \label{fig:form_parse}
\end{figure}

\begin{figure}[h]
  \centering
  \includegraphics[width=\linewidth]{motif_parse}
  \caption{Parsing of Motifs}
